                ...
                <div style={styles.infoContainer}>
                    ...
                    <ul style={styles.infoContainer.ul}>
                        ...
                        <li style={styles.infoContainer.li}>
                            ...
                            <a style={styles.infoContainer.a} href="https://www.linkedin.com/in/andres-buendia-41b127219/" target="_blank">
                                LinkedIn
                            </a>{" "}
                            and my{" "}
                            <a style={styles.infoContainer.a} href="https://github.com/andresbuendia2020" target="_blank">
                                GitHub
                            </a>{" "}
